...
IG.prototype._request = async function (method, action, data = null, version = 2, attempt = 0) {
  try {
    ...
    await wait(500);
    return await this._request(method, action, data, version, attempt);
  }
...
// Returns market details i.e. dealingRules
IG.prototype.getMarket = async function (epic) {
  return await this._request('get', 'markets/' + encodeURIComponent(epic), null, 2);
};
